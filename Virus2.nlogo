...
;;if the person is infected then stop movement. (simulates quaranteen)
to move
  if quarantine?
     [
       ask turtles with [not sick?]  ;;move only if youre not sick
     [ rt random 100
       lt random 100
       fd 1 ]
 ]
 ...
 if not quarantine?
 [
    ask turtles with [not sick?] ;;everyone not sick can move
     [ rt random 100
       lt random 100
       fd 1 ]
     
     
    ask turtles with [sick?] ;;everyone sick moves less.
     [ rt random 10
       lt random 10
       fd 1 ]
